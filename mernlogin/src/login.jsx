...
function Login() {
  return (
    <body class="bg-gradient-to-r from-indigo-600 to-pink-500 p-[10rem]">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900 animate-slide-in-top">login to your account</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="#" method="POST">
        ...
        <div>
          <div class="flex items-center justify-between rounded shadow-md max-w-md transform transition-all duration-300 hover:scale-105">
            <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
            <div class="text-sm">
              <a href="#" class="font-semibold text-gray-50 hover:text-gray-900">Forgot password?</a>
            </div>
          </div>
          <div class="mt-2">
